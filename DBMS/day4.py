...
#col43 
SELECT EMPID,SALARY AS "Current Salary",(SALARY*1.20) AS "New Salary",
ROUND((SALARY*1.20-SALARY),2) AS "Incremented Amount" FROM EMPDETAILS WHERE Designation = 'Manager';
...
#EX 31 WRONG
SELECT Prodid,Pdesc,Price AS "Old_Price",ROUND((Price*(1-0.225)),2) AS "New_Price" FROM Product WHERE Category = 'Sports';
