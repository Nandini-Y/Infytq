...
#col43 
SELECT EMPID,SALARY AS "Current Salary",(SALARY*1.2) AS "New Salary",
ROUND((SALARY*1.2)-SALARY,2) AS "Incremented Amount" FROM EMPDETAILS WHERE Designation = 'Manager';
